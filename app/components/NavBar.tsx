  ...
  return (
    <>
      <nav className="w-full px-4 sm:px-8 md:px-12 lg:px-24 relative">
        ...
        <div className="flex justify-center items-center sm:mb-[-70px] mb-[-40px]">
          ...
          <div className="no-underline flex items-center">
            <div
              className={`relative sm:-top-[70px] -top-[80px] flex-shrink-0 ${
                allImagesLoaded ? "sign-animation" : "sign-hidden"
              }`}
              ...
              <Link href="/">
                ...
                >
                  <Image
                    src={
                      isMainHovered
                        ? "/navbar/mainpage_button_hover.png"
                        : "/navbar/mainpage_button.png"
                    }
                    height={91 * 2}
                    width={112 * 2}
                    alt="Frog Soup Cafe"
          ...
          <div className="hidden md:flex items-center gap-1 ml-3">
            {/* Claim Button */}
            <div
              className={`relative transform -top-[75px] flex-shrink-0 ${
                allImagesLoaded ? "sign-animation" : "sign-hidden"
              }`}
              style={{
                animationDelay:
                  windowWidth >= 640 && !isResizing ? "0.2s" : "0s",
              }}
            ...
            >
              <Link href="/claim">
                <Image
                  src={
                    isClaimHovered
                      ? "/navbar/claim_button_hover.png"
                      : "/navbar/claim_button.png"
                  }
                  height={73 * 2}
                  width={58 * 2}
                  alt="Claim"
                  ...
                  priority
                  onLoadingComplete={() =>
                    setLoadedImages((prev) => ({ ...prev, claim: true }))
                  }
                />
              </Link>
            </div>
            ...
            {/* Burn Button */}
            <div
              className={`relative -top-[65px] flex-shrink-0 ${
                allImagesLoaded ? "sign-animation" : "sign-hidden"
              }`}
              style={{
                animationDelay:
                  windowWidth >= 640 && !isResizing ? "0.4s" : "0.2s",
              }}
            ...
            >
              <Link href="/burn">
                <Image
                  src={
                    isBurnHovered
                      ? "/navbar/burn_button_hover.png"
                      : "/navbar/burn_button.png"
                  }
                  height={78 * 2}
                  width={54 * 2}
                  alt="Burn"
                  ...
                  priority
                  onLoadingComplete={() =>
                    setLoadedImages((prev) => ({ ...prev, burn: true }))
                  }
                />
              </Link>
            </div>
            ...
            {/* Bridge Button */}
            <div
              className={`relative -top-[75px] flex-shrink-0 ${
                allImagesLoaded ? "sign-animation" : "sign-hidden"
              }`}
              style={{
                animationDelay:
                  windowWidth >= 640 && !isResizing ? "0.3s" : "0.1s",
              }}
            ...
            >
              ...
              >
                <Image
                  src={
                    isBridgeHovered
                      ? "/navbar/bridge_button_hover.png"
                      : "/navbar/bridge_button.png"
                  }
                  height={74 * 2}
                  width={68 * 2}
                  alt="Bridge"
                  ...
                  priority
                  onLoadingComplete={() =>
                    setLoadedImages((prev) => ({ ...prev, bridge: true }))
                  }
                />
              </Link>
            </div>
            ...
            <div
              ...
              style={{
                animationDelay:
                  windowWidth >= 640 && !isResizing ? "0.5s" : "0.3s",
              }}
              ...
              >
                <Image
                  src={
                    address
                      ? isWalletHovered
                        ? "/navbar/connected_button_hover.png"
                        : "/navbar/connected_button.png"
                      : isWalletHovered
                      ? "/navbar/connect_button_hover.png"
                      : "/navbar/connect_button.png"
                  }
                  height={83 * 2}
                  width={77 * 2}
                  ...
                  priority
                  onLoadingComplete={() =>
                    setLoadedImages((prev) => ({ ...prev, wallet: true }))
                  }
                />
              </button>
            </div>
      ...
      <div
        ...
        style={{
          boxShadow:
            "0 2px #a05b53, 0 12px #472d3c, 0 14px #302c2e, 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)",
        }}
      >
        <div className="mobile-menu flex flex-col space-y-0 text-[#cfc6b8] pixel-text">
          <Link
            href="/"
            className="p-2 transform transition-transform hover:pl-5"
            onClick={() => setIsMobileMenuOpen(false)}
          >
            MINT
          </Link>
          ...
          <button
            ...
            className="mobile-connect flex items-center p-2 hover:bg-[#5e3643] transform transition-transform hover:pl-5"
          >
